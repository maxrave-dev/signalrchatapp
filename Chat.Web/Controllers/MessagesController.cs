...
namespace Chat.Web.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Message>> Create(NewMessageModel viewModel)
        {
            var user = _context.Users.FirstOrDefault(u => u.UserName == IdentityName);
            var room = _context.Rooms.FirstOrDefault(r => r.Name == viewModel.RoomName);
            if (room == null)
                return BadRequest();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            var message = await _context.Messages
                ...
                .Where(m => m.Id == id && m.FromUser.UserName == IdentityName)
                .FirstOrDefaultAsync();
